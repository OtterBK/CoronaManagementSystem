...
public class HomeGUI extends JFrame{
	...
	private JLabel btn_adminInfoAdd;
	private JLabel btn_adminInfoDel;
...
//		adminInfoPanel.add(btn_adminInfoAdd1);
		...
		btn_adminInfoAdd = new JLabel("계정 추가");
		btn_adminInfoAdd.setIcon(checkIcon);
		btn_adminInfoAdd.setForeground(MyColor.WHITE);
		btn_adminInfoAdd.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		btn_adminInfoAdd.setHorizontalAlignment(SwingConstants.LEFT);
		btn_adminInfoAdd.setBounds(75, 62, 100, 25);
		//btn_adminInfoAdd.setOpaque(false);
		//btn_adminInfoAdd.setBorder(new LineBorder(MyColor.SMOOTHBLACK, 2));
		adminInfoPanel.add(btn_adminInfoAdd);
		btn_adminInfoAdd.addMouseListener(new LabelButton());
		//클릭하면 계정 추가 프레임 열리게
...
//		adminInfoPanel.add(btn_adminInfoDel1);
		...
		btn_adminInfoDel = new JLabel("계정 삭제");
		btn_adminInfoDel.setForeground(MyColor.WHITE);
		btn_adminInfoDel.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		btn_adminInfoDel.setIcon(deleteIcon);
		btn_adminInfoDel.setHorizontalAlignment(SwingConstants.LEFT);
		btn_adminInfoDel.setBounds(245, 62, 100, 25);
		//btn_adminInfoDel.setOpaque(false);
		//btn_adminInfoDel.setBorder(new LineBorder(MyColor.SMOOTHBLACK, 2));
		adminInfoPanel.add(btn_adminInfoDel);
		btn_adminInfoDel.addMouseListener(new LabelButton());
		//클릭하면 계정 삭제 프레임 열리게
		...
		lbl_coronaMap_find.addMouseListener(new LabelButton());
	...
	private class LabelButton extends MouseAdapter{
		public void mousePressed(MouseEvent e) {
			if(e.getSource()==btn_adminInfoAdd) {
				new AdminInfoAddGUI();
			}
			else if(e.getSource()==btn_adminInfoDel) {
			...
			else if(e.getSource()== lbl_coronaMap_find) {
				new CoronaMapCheck();//동선 정보 삭제
			}	
		}
	}
