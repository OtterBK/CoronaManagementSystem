...
public class MyAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tv_coronicID = (TextView) convertView.findViewById(R.id.tv_coronicID) ;
        ...
        tv_coronicID.setText(myItem.getId());
    ...
    public void addItem(Drawable img, String id, String date, String address) {
