...
public class CoronaMapCheck extends JFrame {
	...
	public CoronaMapCheck() {
		...
		tf_id.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(coronic == null) {
					new CheckGUI(CoronaMapCheck.this,id+"번 확진자에 대한 정보가 존재하지 않습니다.", false, false);
				} else {
					coronicId = id;
