...
public class CheckGUI extends JFrame{ //사용자에게 알림을 띄우기 위한 프레임
	...
	private static CheckGUI lastFrame = null; //CheckGUI는 2개가 열릴수 없음 그걸 위함
	private boolean programExit = false; //이 프레임을 닫으면 프로그램까지 종료할 것인가?
	private boolean disposeCaller = false; //이 프레밍를 닫으면 이 프레임을 호출한 프레임 또한 닫을 것인가?
	private JFrame callerFrame; //호출한 프레임
	private JButton okButton; //확인버튼
